...
connection3.setID(3);
connection3.setDetails(
  "Meet others that attend UNCC and share the same hobby as you."
);
...
connection6.setID(6);
connection6.setDetails(
  "Learn how to make your keyboard smoother and sound better"
);
